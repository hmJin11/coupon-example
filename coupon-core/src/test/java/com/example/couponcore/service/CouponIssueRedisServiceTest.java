...
class CouponIssueRedisServiceTest extends TestConfig {
  ...
  public void availableTotalIssueQuantity_1() throws Exception {
    //given
    int totalIssueQuantity = 10;
    long couponId = 1;
    //when
    boolean result =
        couponIssueRedisService.availableTotalIssueQuantity(totalIssueQuantity, couponId);
    //then
  ...
  public void availableTotalIssueQuantity_2() throws Exception {
    //given
    int totalIssueQuantity = 10;
    long couponId = 1;
  ...
  public void availableUserIssueQuantity_1() throws Exception {
    //given
    long couponId = 1;
    long userId = 1;
    //when
  ...
  public void availableUserIssueQuantity_2() throws Exception {
    //given
    long couponId = 1;
    long userId = 1;
    redisTemplate.opsForSet().add(getIssueRequestKey(couponId), String.valueOf(userId));
